...
<body style="background-color: bisque;">
  ...
  <h1 style="text-align: center; color: white">Shifting-Information(Business)</h1>
  <h1 style="color: white">Total Shiting:<?php
 $count = "SELECT COUNT('ID') FROM business_shifttin";
...
<table border="1px" style="width: 900px; margin-left: 250px; text-align: center;" >
      ...
      <tr> 
       ...
       $showdata="SELECT * FROM business_shifttin"; 
       ...
       <tr>   
            ...
            <td> <a onclick="return confirm('ARE YOE SURE!')" href="delete.php?id=<?php  echo $data["ID"];  ?>">Delete</a>
             <a onclick="return confirm('ARE YOE SURE!')" href="delete.php?id=<?php  echo $data["ID"];  ?>">Edit</a>
            </td> 
      </tr>
